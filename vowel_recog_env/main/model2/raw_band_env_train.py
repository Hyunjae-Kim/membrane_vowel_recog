...
if __name__=='__main__':
    ...
    trainX = np.load('../../npy_data/%s/%d%s_%.1fms_trainX.npy'%(data_type, n_band, data_type,time_len)).reshape(-1,1,200)
    trainY = np.load('../../npy_data/%s/%d%s_%.1fms_trainY.npy'%(data_type, n_band, data_type, time_len))
    testX = np.load('../../npy_data/%s/%d%s_%.1fms_testX.npy'%(data_type, n_band, data_type, time_len)).reshape(-1,1,200)
    testY = np.load('../../npy_data/%s/%d%s_%.1fms_testY.npy'%(data_type, n_band, data_type, time_len))
    ...
    print('raw_band_env data shape  -  %.1f ms'%time_len)
