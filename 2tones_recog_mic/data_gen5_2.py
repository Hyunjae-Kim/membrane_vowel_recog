...
if run_type=='sweep1':
    ...
    for freq1 in range(600, 700, 5):
        ...
        for try_num in range(100):
            ...
            if try_num%10==0: print(try_num/100)

        np.save('data/sim_data%d_2/mic/%d_%d.npy'%(data_num, freq1, freq2), whole_pos)
...
if run_type=='sweep2':
    ...
    for freq1 in range(600, 700, 5):
        ...
        np.save('data/sim_data%d_2/mic_2/%d_%d.npy'%(data_num, freq1, freq2), whole_pos)
        print('%d_%d data shape :'%(freq1, freq2), np.shape(whole_pos))