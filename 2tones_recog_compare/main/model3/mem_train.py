...
if __name__=='__main__':
    ...
    trainX = np.load('../../npy_data/%s/%s_%.1fms_trainX.npy'%(data_type, data_type, time_len)).reshape(-1,point_len*6)
    trainY = np.load('../../npy_data/%s/%s_%.1fms_trainY.npy'%(data_type, data_type, time_len))
    testX = np.load('../../npy_data/%s/%s_%.1fms_testX.npy'%(data_type, data_type, time_len)).reshape(-1,point_len*6)
