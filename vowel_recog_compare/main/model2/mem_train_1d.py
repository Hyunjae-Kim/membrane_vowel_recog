...
if __name__=='__main__':
    ...
    trainX = np.load('../../npy_data/%s/%s_%.1fms_trainX.npy'%(data_type, data_type, time_len))#.transpose(0,2,1).reshape(-1,1,2000)
    trainY = np.load('../../npy_data/%s/%s_%.1fms_trainY.npy'%(data_type, data_type, time_len))
    testX = np.load('../../npy_data/%s/%s_%.1fms_testX.npy'%(data_type, data_type, time_len))#.transpose(0,2,1).reshape(-1,1,2000)
